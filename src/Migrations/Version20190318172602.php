 ...
 */
final class Version20190318172602 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE tduree tduree DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE tduree tduree DOUBLE PRECISION DEFAULT NULL');
    }
}
